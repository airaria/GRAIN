def divide_parameters(named_parameters, weight_decay_rate=0.01, lr=None):
    ...
    if len(decay_parameters_names)>0:
        ...
        if lr is not None:
            decay_group = {'params':decay_parameters,   'weight_decay': weight_decay_rate, 'lr':lr}
        else:
            decay_group = {'params': decay_parameters, 'weight_decay': weight_decay_rate}
